local correctPassword = "hohohomerrychristmas" ---------- thats the key lol
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/JoeBidenhub/JoeBidenHub-V2/main/script%20releases%20latest%20download",true))()
...
local function onGetKeyButtonClicked()
        setclipboard("https://link-hub.net/447445/key") ------------- the copy part this gose to the players clipbord
